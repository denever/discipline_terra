...
class ITPhoneNumberField(Field):
    ...
    def clean(self, value):
        ...
        from it_phones import MOBILE_CHOICES, PHONE_CHOICES

        # Split the number and, if present, strip the international prefix
        # from the number
        m = value.split(" ")
    ...
    def __init__(self, attrs=None):
        widgets = (
            forms.widgets.TextInput(
                attrs={"class": "form-control", "placeholder": "Via/Piazza"}
            ),
            forms.widgets.TextInput(
                attrs={"class": "form-control", "placeholder": "Numero Civico"}
            ),
            forms.widgets.TextInput(
                attrs={"class": "form-control", "placeholder": "CAP"}
            ),
            forms.widgets.TextInput(
                attrs={"class": "form-control", "placeholder": "Comune"}
            ),
            forms.widgets.TextInput(
